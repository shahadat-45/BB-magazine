    ...
    <aside class="left-sidebar">
      ...
      <div>
        ...
        <li class="nav-small-cap">
          ...
          <li class="sidebar-item">
            <a class="sidebar-link @yield('add-permission')" href="{{ route('add.permission') }}" aria-expanded="false">
              <span>
          ...
          <li class="sidebar-item">
            <a class="sidebar-link @yield('all-permission')" href="{{ route('all.permission') }}" aria-expanded="false">
              <span>
                <i class="ti ti-lock-open"></i>
              </span>
              <span class="hide-menu">All Permission</span>
            </a>
          </li>

          <li class="sidebar-item">
            <a class="sidebar-link @yield('all-role')" href="{{ route('all.role') }}" aria-expanded="false">
              <span>
                <i class="ti ti-users"></i>
              </span>
              <span class="hide-menu">All Role</span>
            </a>
          </li>

          <li class="sidebar-item">
            <a class="sidebar-link @yield('role-have-permission')" href="{{ route('add.role.have.permission') }}" aria-expanded="false">
              <span>
                <i class="ti ti-settings"></i> {{-- Replaced with valid Themify icon --}}
              </span>
          ...
          <li class="sidebar-item">
            <a class="sidebar-link @yield('assign-permission-of-role')" href="{{ route('assign.permission.of.role') }}" aria-expanded="false">
              <span>
                <i class="ti ti-shield-check"></i>
              </span>
              <span class="hide-menu">Assigned All Permission</span>
            </a>
          </li>

        @endif
        {{-- role and permsission end --}}
